// C# Program to find Maximum number of Contiguous Even Numers in an Array
...
namespace maximumContiguousEven
{
    ...
    {
        static int countMaxContiguousArray(int[] arr, int n)
        {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(countMaxContiguousArray(arr, n));
        }
    }
}