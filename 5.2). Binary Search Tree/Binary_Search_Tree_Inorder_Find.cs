...
namespace Binary_Search_Tree_Inorder_Find
{
    class Program
    {
        public class Tree
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Is value present in Binary Search Tree ? " + tree.Find(4));
            Console.WriteLine("Is value present in Binary Search Tree ? " + tree.Find(14));
...
Is value present in Binary Search Tree ? True
Is value present in Binary Search Tree ? False
*/
