𝗗𝘆𝗻𝗮𝗺𝗶𝗰 𝗽𝗿𝗼𝗴𝗿𝗮𝗺𝗺𝗶𝗻𝗴 is a bottom up technique in which the smaller subproblems are solved first and the result of these are sued to find the solution of the 
larger sub-problems.
