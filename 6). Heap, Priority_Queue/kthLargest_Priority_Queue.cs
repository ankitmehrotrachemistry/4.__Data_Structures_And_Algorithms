...
namespace kthLargest_Priority_Queue
{
    ...
    class Program
    {
        public static int KthLargest(int[] arr, int size, int k)
        {
            ...
            Heap<int> pq = new Heap<int>(false);
        ...
        {
            int[] arr = new int[] { 8, 7, 6, 4, 10, 5, 2, 1 };

            // 1, 2, 4, 5, 6, 7, 8, 10
            
            Console.WriteLine("Kth Largest element using Priority Queue is : " + KthLargest(arr, arr.Length, 4));
...
/*
OUTPUT
Kth Largest element using Priority Queue is : 6
*/
