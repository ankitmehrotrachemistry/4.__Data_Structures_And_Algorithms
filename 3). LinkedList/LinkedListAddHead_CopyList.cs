...
namespace LinkedListAddHead_CopyList
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            LinkedList linkedList1 = linkedList.CopyList();
            Console.Write("LinkedList after copying Linked List is : ");
...
LinkedList after copying Linked List is : 4 3 2 1
*/
